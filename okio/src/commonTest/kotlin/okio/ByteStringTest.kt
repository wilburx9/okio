...
val ByteStringTest by testSuite {
  val bronzeHorseman = "На берегу пустынных волн"

  for (factory in ByteStringFactory.entries) {
    testSuite(factory.name) {
      ...
      test("equalsConstantTimeEmptyTest") {
      ...
      test("toAsciiLowerCaseNoUppercase") {
      ...
      test("substringWithInvalidBounds") {
        val byteString = factory.encodeUtf8("Hello, World!")
      ...
      test("encodeBase64WithoutPadding") {
      ...
      test("encodeBase64UrlWithoutPadding") {
      ...
      test("decodeBase64WithWhitespace") {
      ...
      test("toStringOnLongTextIsTruncated") {
        val raw = (
      ...
      test("toStringOnTextWithNewlines") {
      ...
      test("toStringOnLongDataIsTruncated") {
        val byteString = factory.decodeHex(
          "" +
            "60b420bb3851d9d47acb933dbe70399bf6c92da33af01d4fb770e98c0325f41d3ebaf8986da712c82bcd4d55" +
      ...
      test("copyIntoWithAllParameters") {
        val byteString = factory.encodeUtf8("abcdefgh")
        val byteArray = "WwwwXxxxYyyyZzzz".encodeToByteArray()
